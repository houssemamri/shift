...
jQuery(document).ready( function ($) {
    ...
    ********************************/
    ...
    Main.load_invoices = function (page) {
        ...
        // Make ajax call
        Main.ajax_call(url + 'user/ajax/user_settings', 'GET', data, 'settings_load_invoices');
    ...
    ********************************/
    ...
    /*
     * Detect text edit click
     * 
     * @since   0.0.7.5
     */
    $(document).on('click', '.settings-page .btn-settings-edit-text', function (e) {
        
        $( this ).closest( '.textarea-option' ).removeClass('disabled');
    ...
    $(document).on('click', '.settings-page .settings-save-changes', function (e) {
        ...
        // Make ajax call
        Main.ajax_call(url + 'user/ajax/user_settings', 'POST', data, 'save_user_settings');
    ...
    ********************************/
    ...
    Main.methods.settings_load_invoices = function ( status, data ) {
        ...
        if ( status === 'success' ) {
                ...
                invoices += '<li>'
                                + '<div class="row">'
                                    ...
                                    + '<div class="col-xl-3 col-md-3 col-3 text-right">'
                                        + '<a href="' + url + 'user/print-invoice/' + data.invoices[u].invoice_id + '" class="btn btn-success" target="_blank">'
            ...
            $('.settings-page .settings-list-invoices').html(data.message);
    ...
    ********************************/
    $('.main #change-password').submit(function (e) {
        ...
        // Make ajax call
        Main.ajax_call(url + 'user/ajax/user_settings', 'POST', data, 'change_user_password');
