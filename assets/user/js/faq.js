...
jQuery(document).ready( function ($) {
    ...
    ********************************/
    ...
    Main.load_ticket_replies = function () {
        ...
        // Make ajax call
        Main.ajax_call(url + 'user/ajax/faq', 'GET', data, 'load_ticket_replies');
    ...
    Main.methods.create_new_ticket = function ( status, data ) {
        ...
        if ( status === 'success' ) {
            ...
            setTimeout(function(){
                ...
                document.location.href = url + 'user/get-ticket/' + data.ticket_id;
    ...
    ********************************/
    ...
    $(document).on('keyup', '.faq-page .search-articles', function () {
        ...
        // Make ajax call
        Main.ajax_call(url + 'user/ajax/faq', 'POST', data, 'load_faq_articles_by_search');
    ...
    $(document).on('click', '.single-ticket .change-ticket-status a', function (e) {
        ...
        // Make ajax call
        Main.ajax_call(url + 'user/ajax/faq', 'GET', data, 'set_ticket_status');
    ...
    ********************************/
     ...
     */
     $(document).on('submit', '.submit-new-ticket', function (e) {
        ...
        // Make ajax call
        Main.ajax_call(url + 'user/ajax/faq', 'POST', data, 'create_new_ticket');
     ...
     */
     $(document).on('submit', '.submit-ticket-reply', function (e) {
        ...
        // Make ajax call
        Main.ajax_call(url + 'user/ajax/faq', 'POST', data, 'create_ticket_reply');
