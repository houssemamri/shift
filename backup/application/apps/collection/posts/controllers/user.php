...
class User {
    ...
    public function assets_js() {
        ...
        if ( $this->CI->input->get('q') ) {
            ...
            $data .= '<!-- Modal -->';
            $data .= "\n";
            $data .= '<div class="modal fade" id="file-upload-box" tabindex="-1" role="dialog" aria-labelledby="file-upload-box" aria-hidden="true">';
            $data .= "\n";
                $data .= '<div class="modal-dialog file-upload-box modal-lg modal-dialog-centered" role="document">';
                $data .= "\n";
                    $data .= '<div class="modal-content">';
                    $data .= "\n";
                        $data .= '<div class="modal-header">';
                        $data .= "\n";
                            $data .= '<h5 class="modal-title">' . $this->CI->lang->line('file_upload') . ' <span>( <span class="user-total-storage">' . calculate_size(get_user_option('user_storage', $this->CI->user_id)) . '</span> / ' . calculate_size( plan_feature('storage') ) . ')</span></h5>';
                            $data .= "\n";
                            $data .= '<button type="button" class="close" data-dismiss="modal" aria-label="Close">';
                            $data .= "\n";
                                $data .= '<span aria-hidden="true">&times;</span>';
                        ...
                        $data .= "\n";
                            ...
                            $data .= "\n";
                                ...
                                $data .= "\n";
                                    $data .= '<div class="drag-and-drop-files">';
                                    $data .= "\n";
                                        $data .= '<div>';
                                        $data .= "\n";
                                            $data .= '<i class="icon-cloud-upload"></i><br>';
                                            $data .= "\n";
                                            $data .= $this->CI->lang->line('drag_drop_files');
                                            $data .= "\n";
                                        $data .= '</div>';
                                        $data .= "\n";
                                    $data .= '</div>';
                            ...
                            $data .= "\n";
                                $data .= '<div class="col-xl-12">';
                                $data .= "\n";
                                    $data .= '<ul class="file-uploaded-box-files">';
                                    $data .= '</ul>';
                                    $data .= "\n";
                                $data .= '</div>';
                                $data .= "\n";
                        ...
                        $data .= "\n";
                            ...
                            $data .= "\n";
                                if ( get_option('app_posts_enable_dropbox') ) {
                                    $data .= '<button class="btn dropbox-picker pull-left" id="OpenDropboxFilePicker"><i class="icon-social-dropbox"></i></button>';
                                    $data .= "\n";
                                }
                                if ( get_option('app_posts_enable_pixabay') ) {
                                    $data .= '<button class="btn pixabay-drive-picker" id="auth"><i class="fab fa-wpexplorer"></i></button>';
                                    $data .= "\n";
                                }
                                $data .= '<button class="btn select-all-uploaded-media"><i class="icon-plus"></i> ' . $this->CI->lang->line('add_to_post') . '</button>';
                                $data .= "\n";
                            $data .= '</div>';
                            $data .= "\n";
                        $data .= '</div>';
