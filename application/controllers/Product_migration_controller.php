	  ...
	  if (empty($setting_data)) {
       ...
       // Create a Magento database connection dynamically after a successful Magento database connection is made.
  	   ...
  	   if(empty($this->opencart_db)){
          ...
          // Creating "..._product_category_mapping" table dynamically, specific to current user, only if it doesn't already exist.
          ...
          // Creating "..._product_mapping" table dynamically, specific to current user, only if it doesn't alreast exist.
