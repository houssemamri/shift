                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo site_url('user/faq-page') ?>"><?php echo $this->lang->line('support_center'); ?></a></li>
                                            <?php
                                            if ( $parent < 1 ) {
                                                ?>
                                                <li class="breadcrumb-item">
                                                    <a href="<?php echo site_url('user/faq-categories/' . $category_id) ?>">
                                                        <?php
                                                        echo $category;
                                                        ?>
                                                    </a>
                                ...
                                <div class="panel-body">
                                    <div class="article">
                                        ...
                                        <?php
                                        echo @$article['data'][$this->config->item('language')]['body'];
                                        ?>                                       
                                    </div>
                                </div>
                            </div>
