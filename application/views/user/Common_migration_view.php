...
#database-connection-log, #product-migration-log, #customer-migration-log, #order-migration-log {
  height: 250px;
...
#database-connection-log h3, #product-migration-log h3, #customer-migration-log h3, #order-migration-log h3 {
  color: #FFFFFF;
              ...
              <div class="col-lg-12 nopadding" id="wizard">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane active p-2" id="tab-one-content">
                    ...
                    <div class="col-lg-12" id="database-connection-log">
                  ...
                  <div class="tab-pane fade p-2" id="tab-two-content">
                    ...
                    <div class="col-lg-12" id="product-migration-log">
                  ...
                  <div class="tab-pane fade p-2" id="tab-three-content">
                    ...
                    <div class="col-lg-12" id="customer-migration-log">
                  ...
                  <div class="tab-pane fade p-2" id="tab-four-content">
                    ...
                    <div class="col-lg-12" id="order-migration-log">
                      <h3 class="col-lg-12 mt-2 mb-2">Activity Log: Customer Migartion Status</h3>
                    </div>
                    <?php echo form_close(); ?>
                    <div class="button-group mb-2 mt-2 col-lg-12" style="overflow: auto;">
            ...
            function(data) {
              if(data) {
                if(data.item == 'category') {
                  if(data.migration_status == 'successful') {
                    jQuery('#product-migration-log').append('<div class="alert alert-success col-lg-12" role="alert">Category migration successful: ' + data.item_name + '.</div>');
                  } else {
                    jQuery('#product-migration-log').append('<div class="alert alert-danger col-lg-12" role="alert">Category migration failed: ' + data.item_name + '.</div>');
                  }
                } else {
                  if(data.migration_status == 'successful') {
                    jQuery('#product-migration-log').append('<div class="alert alert-success col-lg-12" role="alert">Product migration successful: ' + data.item_name + '.</div>');
                  } else {
                    jQuery('#product-migration-log').append('<div class="alert alert-danger col-lg-12" role="alert">Product migration failed: ' + data.item_name + '.</div>');
                  }
                }
              }
            }
