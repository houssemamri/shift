                ...
                <div class="col-xl-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <?php echo form_open('user/teams', ['class' => 'new-member', 'data-csrf' => $this->security->get_csrf_token_name()]) ?>
                                <div class="list-group">
                                    <div class="list-group-item" id="input-fields">
                                        <div class="form-group">
                                            <input class="form-control username" type="text" placeholder="<?php echo $this->lang->line( 'mu316' ); ?>" value="m_" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control member-role" required>
                                                <option disabled><?php echo $this->lang->line( 'member_role' ); ?></option>
                                                <option value="0"><?php echo $this->lang->line( 'employee' ); ?></option>
                                        ...
                                        <div class="form-group">
                                            <input class="form-control password" type="password" placeholder="<?php echo $this->lang->line( 'mu317' ); ?>" required>
                                        </div>
                                        <div class="form-group buttons-control">
                                            <button type="submit" class="btn btn-success pull-right"><i class="far fa-save"></i> <?php echo $this->lang->line( 'mu315' ); ?></button>
                                        </div>
                                    </div>
                                </div>
                            <?php echo form_close() ?>
            ...
            <div class="modal-body">
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-member-settings" role="tabpanel" aria-labelledby="nav-member-settings">
                        <?php echo form_open('user/teams', ['class' => 'update-member-data']) ?>
                            <div class="list-group">
                                <div class="list-group-item" id="input-fields">
                                    <div class="form-group">
                                        <input class="form-control username" type="text" placeholder="<?php echo $this->lang->line('mu316'); ?>" value="m_user10" disabled>
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control email" type="text" placeholder="<?php echo $this->lang->line('member_email'); ?>" required>
                                    </div>
                                    ...
                                    <div class="form-group buttons-control">
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-6 col-sm-6 col-xs-6">
                                                ...
                                                <p class="pull-left confirm"><?php echo $this->lang->line('mu68'); ?> <a href="#" class="delete-member-account yes"><?php echo $this->lang->line('mu69'); ?></a><a href="#" class="no"><?php echo $this->lang->line('mu70'); ?></a></p>
                                            </div>
