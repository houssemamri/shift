...
trait Emails_helper {
    ...
    public function assets(){
        ...
        . ' .btn-default:hover,.btn-default:active,.btn-default:focus{
            ...
            .sellected-accounts.list-group > ul > li > h4 {
                margin-bottom: 0;
                font-size: 16px;
                line-height: 35px;
            }
            .sellected-accounts.list-group > ul > li > h4 .sellos {
            ...
            .sellected-accounts.list-group > ul > li > h4 .sellos:hover {
                opacity: 0.7;
            }
            .sellected-accounts.list-group > ul > li > h4 .sellos.active {
                background-color: #ea6759;
                border-color: #ea6759;
            }
            .sellected-accounts.list-group > ul > li > h4 .sellos.active:hover {
                opacity: 0.7;
            }
            ...
            section>.tool-page .sellos.active, section>.tool-page .sellos.active:active, section>.tool-page .sellos.active:focus {
                background-color: #ea6b4b;
            ...
            window.onload = function(){
                    ...
                    http.onreadystatechange = function() {
                        if(http.readyState == 4 && http.status == 200) {
                            ...
                            if (data)
                            {
                                ...
                                if(data == 2) {
                                    Main.popup_fon('sube', Main.translation.mm121 + ' " . plan_feature('publish_accounts') . " ' + Main.translation.mm122, 1500, 5000);
                                } else {
                                    for (var u = 0; u < data.length; u++)
                                    {
                                        selac += '<div class=\"list-group-item\"><div class=\"row\"><div class=\"col-md-10\">'+get_socio(data[u].network_name)+' '+data[u].user_name+'</div><div class=\"col-md-2 text-right\"><a href=\"#\" data-id=\"'+data[u].meta_id+'\" class=\"delete-planner-meta\">".$CI->lang->line('mm133')."</a></div></div></div>';
                                    }
                    ...
                    http.onreadystatechange = function() {
                        if(http.readyState == 4 && http.status == 200) {
                            ...
                            if (data) {
                                ...
                                {
                                    if(data[u].status == 1){
                                        var shotim = '<i class=\"fa fa-calendar-plus-o\"></i> ".$CI->lang->line('mt8')."' + Main.calculate_time(data[u].totime, data[u].tim) + '</div><div class=\"col-md-2 text-right\"><a href=\"#\" data-id=\"'+data[u].rule_id+'\" data-res=\"'+data[u].resend_id+'\" class=\"cancel-planner-sched\">".$CI->lang->line('mt7')."</a></div>';                                
                                    } else if(data[u].status == 2){
                                        var shotim = '<i class=\"fa fa-calendar-check-o\"></i> ".$CI->lang->line('mu57')." ' + Main.calculate_time(data[u].totime, data[u].tim) + ' ".$CI->lang->line('mm104')."</div>';                                  
                                    } else if(data[u].status == 3){
                                        var shotim = '<i class=\"fa fa-calendar-times-o\"></i> <strong style=\"color: #ea6b4b;\">".$CI->lang->line('mt9')."</strong></div>';                                  
                                    }
                                    selo += '<div class=\"list-group-item\"><div class=\"col-md-10\">'+shotim+'</div>';
                                }
                        ...
                        if(http.readyState == 4 && http.status == 200) {
                            ...
                            if (data)
                            {
                                ...
                                for (var u = 0; u < data.length; u++)
                                {
                                    ...
                                    if(data[u].status == 1){
                                        var shotim = '<i class=\"fa fa-calendar-plus-o\"></i> ".$CI->lang->line('mt8')." '+toti+'</div><div class=\"col-md-2 text-right\"><a href=\"#\" data-id=\"'+data[u].rule_id+'\" data-res=\"'+data[u].resend_id+'\" class=\"cancel-planner-sched\">".$CI->lang->line('mt7')."</a></div>';                                
                                    } else if(data[u].status == 2){
                            ...
                            if (data) {
                                ...
                                if(data != 2) {
                                    for (var u = 0; u < data.res.length; u++) {
                                        ...
                                        selac += '<div class=\"list-group-item\"><div class=\"row\"><div class=\"col-md-10\"><span class=\"icon pull-left\" style=\"background-color: #5fd0b9\"><i class=\"fa fa-users\" style=\"color:#fff;font-size: small;\"></i></span> ' + data.res[u].name + '</div><div class=\"col-md-2 text-right\"><a href=\"#\" data-id=\"' + data.res[u].list_id + '\" class=\"select-group-meta'+ini+'\">' + selo + '</a></div></div></div>';
                                    }
                                    document.querySelector('.sellected-accounts').innerHTML = selac;
                                } else {
                    ...
                    http.onreadystatechange = function() {
                        if(http.readyState == 4 && http.status == 200) {
                            ...
                            if (data)
                            {
                                ...
                                for (var u = 0; u < data.length; u++)
                                {
                                    allpll += '<div class=\"list-group-item\" data-res=\"'+data[u].resend_id+'\" data-met=\"'+data[u].meta_id+'\"><div class=\"row\"><div class=\"col-md-2\"><select class=\"days\">';
                                        var rule1 = '';
                                        if(data[u].rule1 == 1){
                                    ...
                                    allpll += '</select></div><div class=\"col-md-2 text-right\"><a href=\"#\" class=\"delete-planner-rule\">".$CI->lang->line('mm133')."</a></div></div></div>';                     
                                }
                        ...
                        if(http.readyState == 4 && http.status == 200) {
                            ...
                            if (data) {
                                ...
                                if(document.querySelectorAll('.planner-list .list-group-item').length > 0){
                                    document.getElementsByClassName('planner-list')[0].insertAdjacentHTML('beforeend','<div class=\"list-group-item\" data-res=\"'+dat.resend_id+'\" data-met=\"'+dat.meta_id+'\"><div class=\"row\"><div class=\"col-md-2\"><select class=\"days\"><option value=\"1\">".$CI->lang->line('mu193')."</option><option value=\"2\">".$CI->lang->line('mu194')."</option><option value=\"3\">".$CI->lang->line('mu195')."</option><option value=\"4\">".$CI->lang->line('mu196')."</option><option value=\"5\">".$CI->lang->line('mu197')."</option><option value=\"6\">".$CI->lang->line('mu198')."</option><option value=\"7\">".$CI->lang->line('mu199')."</option></select></div><div class=\"col-md-3 clean\"><select class=\"plan-time\"><option value=\"00:00\">00:00</option><option value=\"01:00\">01:00</option><option value=\"02:00\">02:00</option><option value=\"03:00\">03:00</option><option value=\"04:00\">04:00</option><option value=\"05:00\">05:00</option><option value=\"06:00\">06:00</option><option value=\"07:00\">07:00</option><option value=\"08:00\">08:00</option><option value=\"09:00\">09:00</option><option value=\"10:00\">10:00</option><option value=\"11:00\">11:00</option><option value=\"12:00\">12:00</option><option value=\"13:00\">13:00</option><option value=\"14:00\">14:00</option><option value=\"15:00\">15:00</option><option value=\"16:00\">16:00</option><option value=\"17:00\">17:00</option><option value=\"18:00\">18:00</option><option value=\"19:00\">19:00</option><option value=\"20:00\">20:00</option><option value=\"21:00\">21:00</option><option value=\"22:00\">22:00</option><option value=\"23:00\">23:00</option></select></div><div class=\"col-md-3\"><select class=\"when\"><option value=\"1\">".$CI->lang->line('mu200')."</option><option value=\"2\">".$CI->lang->line('mu201')."</option><option value=\"3\">".$CI->lang->line('mu202')."</option><option value=\"4\">".$CI->lang->line('mu203')."</option></select></div><div class=\"col-md-2 clean\"><select class=\"repeat\"><option value=\"1\">1 ".$CI->lang->line('mu204')."</option><option value=\"2\">2 ".$CI->lang->line('mu205')."</option><option value=\"3\">3 ".$CI->lang->line('mu205')."</option><option value=\"4\">4 ".$CI->lang->line('mu205')."</option><option value=\"5\">5 ".$CI->lang->line('mu205')."</option><option value=\"6\">6 ".$CI->lang->line('mu205')."</option><option value=\"7\">7 ".$CI->lang->line('mu205')."</option><option value=\"8\">8 ".$CI->lang->line('mu205')."</option><option value=\"9\">9 ".$CI->lang->line('mu205')."</option><option value=\"10\">10 ".$CI->lang->line('mu205')."</option><option value=\"11\">11 ".$CI->lang->line('mu205')."</option><option value=\"12\">12 ".$CI->lang->line('mu205')."</option></select></div><div class=\"col-md-2 text-right\"><a href=\"#\" class=\"delete-planner-rule\">".$CI->lang->line('mm133')."</a></div></div></div>');
                                } else {
                                    document.getElementsByClassName('planner-list')[0].innerHTML = '<div class=\"list-group-item\" data-res=\"'+dat.resend_id+'\" data-met=\"'+dat.meta_id+'\"><div class=\"row\"><div class=\"col-md-2\"><select class=\"days\"><option value=\"1\">".$CI->lang->line('mu193')."</option><option value=\"2\">".$CI->lang->line('mu194')."</option><option value=\"3\">".$CI->lang->line('mu195')."</option><option value=\"4\">".$CI->lang->line('mu196')."</option><option value=\"5\">".$CI->lang->line('mu197')."</option><option value=\"6\">".$CI->lang->line('mu198')."</option><option value=\"7\">".$CI->lang->line('mu199')."</option></select></div><div class=\"col-md-3 clean\"><select class=\"plan-time\"><option value=\"00:00\">00:00</option><option value=\"01:00\">01:00</option><option value=\"02:00\">02:00</option><option value=\"03:00\">03:00</option><option value=\"04:00\">04:00</option><option value=\"05:00\">05:00</option><option value=\"06:00\">06:00</option><option value=\"07:00\">07:00</option><option value=\"08:00\">08:00</option><option value=\"09:00\">09:00</option><option value=\"10:00\">10:00</option><option value=\"11:00\">11:00</option><option value=\"12:00\">12:00</option><option value=\"13:00\">13:00</option><option value=\"14:00\">14:00</option><option value=\"15:00\">15:00</option><option value=\"16:00\">16:00</option><option value=\"17:00\">17:00</option><option value=\"18:00\">18:00</option><option value=\"19:00\">19:00</option><option value=\"20:00\">20:00</option><option value=\"21:00\">21:00</option><option value=\"22:00\">22:00</option><option value=\"23:00\">23:00</option></select></div><div class=\"col-md-3\"><select class=\"when\"><option value=\"1\">".$CI->lang->line('mu200')."</option><option value=\"2\">".$CI->lang->line('mu201')."</option><option value=\"3\">".$CI->lang->line('mu202')."</option><option value=\"4\">".$CI->lang->line('mu203')."</option></select></div><div class=\"col-md-2 clean\"><select class=\"repeat\"><option value=\"1\">1 ".$CI->lang->line('mu204')."</option><option value=\"2\">2 ".$CI->lang->line('mu205')."</option><option value=\"3\">3 ".$CI->lang->line('mu205')."</option><option value=\"4\">4 ".$CI->lang->line('mu205')."</option><option value=\"5\">5 ".$CI->lang->line('mu205')."</option><option value=\"6\">6 ".$CI->lang->line('mu205')."</option><option value=\"7\">7 ".$CI->lang->line('mu205')."</option><option value=\"8\">8 ".$CI->lang->line('mu205')."</option><option value=\"9\">9 ".$CI->lang->line('mu205')."</option><option value=\"10\">10 ".$CI->lang->line('mu205')."</option><option value=\"11\">11 ".$CI->lang->line('mu205')."</option><option value=\"12\">12 ".$CI->lang->line('mu205')."</option><option value=\"13\">13 ".$CI->lang->line('mu205')."</option><option value=\"14\">14 ".$CI->lang->line('mu205')."</option><option value=\"15\">15 ".$CI->lang->line('mu205')."</option><option value=\"16\">16 ".$CI->lang->line('mu205')."</option><option value=\"17\">17 ".$CI->lang->line('mu205')."</option><option value=\"18\">18 ".$CI->lang->line('mu205')."</option><option value=\"19\">19 ".$CI->lang->line('mu205')."</option><option value=\"20\">20 ".$CI->lang->line('mu205')."</option><option value=\"21\">21 ".$CI->lang->line('mu205')."</option><option value=\"22\">22 ".$CI->lang->line('mu205')."</option><option value=\"23\">23 ".$CI->lang->line('mu205')."</option><option value=\"24\">24 ".$CI->lang->line('mu205')."</option><option value=\"25\">25 ".$CI->lang->line('mu205')."</option><option value=\"26\">26 ".$CI->lang->line('mu205')."</option><option value=\"27\">27 ".$CI->lang->line('mu205')."</option><option value=\"28\">28 ".$CI->lang->line('mu205')."</option><option value=\"29\">29 ".$CI->lang->line('mu205')."</option><option value=\"30\">30 ".$CI->lang->line('mu205')."</option></select></div><div class=\"col-md-2 text-right\"><a href=\"#\" class=\"delete-planner-rule\">".$CI->lang->line('mm133')."</a></div></div></div>';
                                }
                            }
                            reload_it();
                        }
                ...
                function show_pagination(total,object,bid) {
                    ...
                    if (parseInt(bid.page) > 1) {
                        ...
                        var pages = '<li class=\"page-item\"><a href=\"#\" data-page=\"' + bac + '\" class=\"pnum\">' + Main.translation.mm128 + '</a></li>';
                    } else {
                    ...
                    if (next < Math.round(tot)) {
                        document.querySelector(object+' .pagination').innerHTML = pages + '<li class=\"page-item\"><a href=\"#\" data-page=\"' + next + '\" class=\"page-link pnum\">' + Main.translation.mm129 + '</a></li>';
                    } else {
                        document.querySelector(object+' .pagination').innerHTML = pages + '<li class=\"page-item pagehide\"><a href=\"#\" class=\"page-link\">' + Main.translation.mm129 + '</a></li>';
                    }
                }
                    ...
                    http.onreadystatechange = function() {
                        if(http.readyState == 4 && http.status == 200) {
                            ...
                            if (data) {
                                ...
                                document.querySelector('.mess-stat .list-group ul').innerHTML = '<p class=\"no-results-found\">" . $CI->lang->line('mm154') . "</p>';
                            }
                            if(posts.by == 1){                               
