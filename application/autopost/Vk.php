...
class Vk implements Autopost {
    ...
    public function post($args, $user_id = null) {
        ...
        // Set some options - we are passing in a useragent too here
        curl_setopt_array($curl, array(CURLOPT_RETURNTRANSFER => 1, CURLOPT_URL => 'https://api.vk.com/method/wall.post' . '?' . urldecode(http_build_query($post_params)),CURLOPT_HEADER => false));
            ...
            'hidden' => '<div>
                            <div class="col-md-12 clean">
                                <div class="input-group search">
                                    <input type="text" placeholder="' . $this->CI->lang->line('vk_copy_paste_url') . '" class="form-control search_accounts token">
