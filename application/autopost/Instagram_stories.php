 ...
 * @link     https://www.midrub.com/
 */
class Instagram_stories implements Autopost {
    ...
    public function connect() {
        ...
        if ( $this->CI->input->post() ) {
                ...
                if ( file_exists(APPPATH . 'autopost/Instagram.php') ) {
                    ...
                    try {
                        ...
                        if ( !$this->CI->networks->get_network_data('instagram_stories', $this->CI->user_id, $username) ) {
                            ...
                            echo $this->CI->ecl('Social_login_connect')->view($this->CI->lang->line('social_connector'), '<p class="alert alert-success">' . $this->CI->lang->line('mm71') . '</p>', true);
            ...
            echo get_instance()->ecl('Social_login')->content('Username', 'Password', 'Connect', $this->get_info(), 'instagram_stories', $this->CI->lang->line('mu209'));
