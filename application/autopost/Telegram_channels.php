 ...
 * @link     https://www.midrub.com/
 */
class Telegram_channels implements Autopost {
    ...
    public function connect() {
        ...
        if ($this->CI->input->post()) {
            ...
            if ($this->CI->form_validation->run() == false) {
                ...
                echo $this->CI->ecl('Social_login_connect')->view($this->CI->lang->line('social_connector'), '<p class="alert alert-success">' . strip_tags(display_mess(148)) . '</p>', true);
            ...
            echo get_instance()->ecl('Social_login')->content('Api Key', '', 'Connect', $this->get_info(), 'telegram_channels', $this->CI->lang->line('mu395'));            
    ...
    public function post($args, $user_id = null) {
        ...
        if ( $user_id ) {
            ...
            $user_details = $this->CI->networks->get_network_data(strtolower('telegram_channels'), $user_id, $args['account']);
