...
class Rss_model extends CI_MODEL {
    ...
    public function get_post( $user_id, $post_id ) {
        ...
        $this->db->select('rss_posts.rss_id,rss_posts.post_id,rss_posts.title,rss_posts.content,rss_posts.url,rss_posts.img,rss_posts.published,rss_posts.scheduled', false);
        $this->db->from('rss_posts');
        $this->db->where($data);
