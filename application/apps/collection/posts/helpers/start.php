...
class Start {
        ...
        if ( $get_posts ) {
            ...
            foreach ( $get_posts as $post ) {
                ...
                if ( in_array( $post->network_name, $networks_icon ) ) {
                    ...
                    $network_icon = (new MidrubAppsCollectionPostsHelpers\Accounts)->get_network_icon($post->network_name);
    ...
    public function insights_display_all_accounts() {
        ...
        // Get key's input
        $search_key = $this->CI->input->get('key');
        ...
        // Get accounts list
        $accounts_list = (new MidrubAppsCollectionPostsHelpers\Accounts)->list_accounts_for_composer($this->CI->networks_model->get_accounts( $this->CI->user_id, ($page * $limit), $limit, $key, 1 ));
