            ...
            <div class="modal-body">
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade active show" id="nav-new-rss" role="tabpanel" aria-labelledby="nav-new-rss">
                        <?php echo form_open('user/app/posts', array('class' => 'register-new-rss-feed', 'data-csrf' => $CI->security->get_csrf_token_name())) ?>
...
<div class="modal fade" id="file-upload-box" tabindex="-1" role="dialog" aria-labelledby="file-upload-box" aria-hidden="true">
    <div class="modal-dialog file-upload-box modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">        
            <div class="modal-header">
                <h5 class="modal-title"><?php echo $CI->lang->line('file_upload'); ?> <span>( <span class="user-total-storage">
                    <?php
                    echo calculate_size(get_user_option('user_storage', $CI->user_id)) . '</span> / ' . calculate_size( plan_feature('storage') ) . ')</span>';
                    ?>
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-upload" role="tabpanel" aria-labelledby="pills-upload-tab">
                                <div class="drag-and-drop-files">
                                    <div>
                                        ...
                                        <?php
                                        echo $CI->lang->line('drag_drop_files');
                                        ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="pills-import" role="tabpanel" aria-labelledby="pills-import-tab">
                                <div class="import-images-from-url">
                                    <?php echo form_open('user/app/posts', array('class' => 'download-images-from-url', 'data-csrf' => $CI->security->get_csrf_token_name())) ?>
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <textarea class="imported-urls" placeholder="<?php echo $CI->lang->line('enter_urls_one_per_line'); ?>" required></textarea>
                                            </div>
                                        </div>  
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <button type="submit" class="btn btn-download-photos"><i class="icon-cloud-download"></i> <?php echo $CI->lang->line('download'); ?></button>
                                            </div>
                                        </div> 
                                    <?php echo form_close(); ?>
                                </div>
            ...
            <div class="modal-footer">
                <div>
                    ...
                    ?>
                    <button class="btn select-all-uploaded-media"><i class="icon-plus"></i><?php echo $CI->lang->line('add_to_post'); ?></button>
                </div>
            </div>
        </div>
    </div>
