...
namespace MidrubApps\Collection\Dashboard\Widgets;

defined('BASEPATH') OR exit('No direct script access allowed');

// Define the namespaces to use
use MidrubApps\Collection\Dashboard\Interfaces as MidrubAppsCollectionDashboardInterfaces;
 ...
 * @since 0.0.7.0
*/
class Storage implements MidrubAppsCollectionDashboardInterfaces\Widgets {
