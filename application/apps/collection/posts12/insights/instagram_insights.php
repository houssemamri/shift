 ...
 * @since 0.0.7.0
 */
class Instagram_insights implements MidrubAppsCollectionPostsInterfaces\Insights {
     ...
     */
    protected
            $CI, $url = 'https://graph.facebook.com/v3.2/';
        ...
        switch ($type) {
            ...
            case 'comments':
                ...
                if ( $parent ) {
                    ...
                    $post = json_decode(post( $this->url . $id . '/comments', array('message' => $msg), $network[0]->token), true);
